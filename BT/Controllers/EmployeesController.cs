...
namespace BT.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        AutoGenneratekey strPro = new AutoGenneratekey();
        ...
        public ActionResult Create([Bind(Include = "PersonID,PersonName,Conpany,Adđress")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonID,PersonName,Conpany,Adđress")] Employee employee)
        {
            if (ModelState.IsValid)
            {
